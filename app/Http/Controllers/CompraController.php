...
class CompraController extends Controller
{
    public function compra(Request $request){
        ...
        $codigo6= $request->codigo6;
        $codigo7= $request->codigo7;
        $codigo8= $request->codigo8;
        $codigo9= $request->codigo9;
        $codigo10= $request->codigo10;
        $descr = $request->descr;
        ...
        foreach ($codigos as $indice => $valor5) {
            foreach ($valor5 as $key => $value) {
               if ($value==$codigo1 || $value == $codigo2 || $value==$codigo3 || $value == $codigo4 ||$value==$codigo5 || $value == $codigo6 ||$value==$codigo7 || $value == $codigo8||$value==$codigo9 || $value == $codigo10) {

               	 $contador = $contador+$valor5['valor'];
               }
            }
        }
        ...
        if ($contador>$valor) {
        	...
        	$inf=[];
       		 ...
       		 $inf[]=["Nombre"=>$nombre,"Apellido"=>$apellido,"Cedula"=>$cedula,"Numero"=>$numero,"Valor"=>$valor,"Codigo1"=>$codigo1,"Codigo2"=>$codigo2,"Codigo3"=>$codigo3,"Codigo4"=>$codigo4,"Codigo5"=>$codigo5,"Codigo6"=>$codigo6,"Codigo7"=>$codigo7,"Codigo8"=>$codigo8,"Codigo9"=>$codigo9,"Codigo10"=>$codigo10,"Contador"=>$contador,"Descr"=>$descr];

      
     	   $datos=[
       	     'personas'=>$inf
       		 ];
     		return view('informacion',$datos);
        }
